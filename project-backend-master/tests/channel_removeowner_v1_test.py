...
def test_removeowner_channel_id_invalid(clear_register_user_and_reset_http):
    '''
    ...
    response = requests.post(f'{BASE_URL}/channel/removeowner/v1',
                             json={'token': user_all[0]['token'],
                                   'channel_id': 9999,
...
def test_removeowner_user_id_invalid(clear_register_user_and_reset_http):
    '''
...
def test_removeowner_user_not_owner(clear_register_user_and_reset_http):
    '''
    Test if a non-owner's u_id is provided, it should raise input error
    HTTP test
    '''
    user_all, channel_all = clear_register_user_and_reset_http
...
def test_removeowner_user_only_owner(clear_register_user_and_reset_http):
    '''
    Test if the u_id's corresponding user is the only owner, it should raise input error
    HTTP test
    '''
    user_all, channel_all = clear_register_user_and_reset_http
...
def test_removeowner_user_not_authorised(clear_register_user_and_reset_http):
    '''
...
def test_removeowner_global_owner(clear_register_user_and_reset_http):
    '''
