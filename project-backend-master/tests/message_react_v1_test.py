...
Functions:
    ...
    test_already_has_react_channel()
    test_already_has_react_dm()
    test_not_member_of_channel()
    test_not_member_of_dm()
    test_two_users_add_same_react_channel()
    test_two_users_add_same_react_dm()
    test_two_consecutive_reacts_channel()
    test_two_consecutive_reacts_dm()
    test_react_someone_else_message_channel()
    test_react_someone_else_message_dm()
'''
import pytest
import requests
...
def test_channel_message_check_return_type(clear_register_user_and_create_channel):
    '''
    This test verifies that a user can react to a
    ...
    requests.post(f"{BASE_URL}/channels/create/v2",
                  json={"token": user['token'], "name": "Tiger Channel", "is_public": True})
...
def test_dm_message_check_return_type(clear_register_users_and_create_dm):
    ...
    requests.post(f"{BASE_URL}/dm/create/v1",
                  json={"token": user_1['token'], "u_ids": [user_2['auth_user_id']]})
...
def test_already_has_react_channel(clear_register_user_and_create_channel):
    '''
    This test verifies that if a user tries to react
    with a react_id which they have already used on
...
def test_already_has_react_dm(clear_register_users_and_create_dm):
    '''
    This test verifies that if a user tries to react
    with a react_id which they have already used on
...
def test_two_users_add_same_react_channel(clear_register_user_and_create_channel):
    '''
    This test verifies that two users can add the
    same react to a particular message in a channel.
    '''
    user_1, channel = clear_register_user_and_create_channel
...
def test_two_users_add_same_react_dm(clear_register_users_and_create_dm):
    '''
    This test verifies that two users can add the
    same react to a particular message in a dm.
    '''
    user_1, user_2, dm = clear_register_users_and_create_dm
...
def test_two_consecutive_reacts_channel(clear_register_user_and_create_channel):
    '''
    This test verifies that a user can react
...
def test_two_consecutive_reacts_dm(clear_register_users_and_create_dm):
    '''
    This test verifies that a user can react
    to two different messages consecutively.
    '''
...
def test_react_someone_else_message_channel(clear_register_user_and_create_channel):
    '''
    This test verifies that a user can react
    to someone else's messages in a channel.
    '''
    user_1, channel = clear_register_user_and_create_channel
...
def test_react_someone_else_message_dm(clear_register_users_and_create_dm):
    '''
    This test verifies that a user can react
    to someone else's messages in a dm.
    '''
    user_1, user_2, dm = clear_register_users_and_create_dm
